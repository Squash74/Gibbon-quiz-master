...
const quizData = {
    christmas: [
        ...
        { question: "Which country started the tradition of exchanging gifts at Christmas?", answer: "Italy (Ancient Rome)" },
        { question: "What beverage is traditionally left out for Santa Claus on Christmas Eve?", answer: "Milk (and cookies)" },
        ...
        { question: "In what decade did Coca-Cola start using Santa Claus in their advertising?", answer: "1920s (1931 specifically)" },
    ...
    movies: [
        ...
        { question: "Who composed the music for 'The Lion King'?", answer: "Hans Zimmer (songs by Elton John and Tim Rice)" },
    ...
    places: [
        ...
        { question: "What is the largest desert in the world?", answer: "Antarctica (or Sahara if considering hot deserts)" },
        ...
        { question: "Which South African province is known as the 'Garden Route'?", answer: "Western Cape (and Eastern Cape)" },
        ...
        { question: "What is the largest waterfall in the world by volume?", answer: "Victoria Falls (or Iguazu Falls)" },
        ...
        { question: "In which South African province is the Kruger National Park primarily located?", answer: "Mpumalanga (and Limpopo)" },
        ...
        { question: "Which European city is divided by the Danube River?", answer: "Budapest (or Vienna)" },
    ...
    people: [
        ...
        { question: "Which South African runner is known as the 'Blade Runner'?", answer: "Oscar Pistorius" },
        ...
        { question: "Which South African swimmer won gold at the 2004 Olympics?", answer: "Roland Schoeman (or Ryk Neethling)" },
        { question: "Who painted 'The Last Supper'?", answer: "Leonardo da Vinci" },
        { question: "Who was the first person to circumnavigate the globe?", answer: "Ferdinand Magellan (completed by Juan Sebastián Elcano)" },
        { question: "Which South African entrepreneur founded Naspers?", answer: "W.A. Hofmeyr and others (or Koos Bekker as CEO who grew it)" },
    ...
    sport: [
        ...
        { question: "What is the name of South Africa's premier domestic cricket competition?", answer: "CSA 4-Day Franchise Series (or Sunfoil Series)" },
